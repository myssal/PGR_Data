...
function XUiGridTreasureTask:AutoInitUi()
    ...
    self.TxtTaskDescribe = self.Transform:Find("PanelProgress/TxtTaskDescribe"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtTaskNumQian = self.Transform:Find("PanelProgress/TxtTaskNumQian"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ProgressBg  = self.Transform:Find("PanelProgress/ProgressBg")
    self.ImgProgress = self.Transform:Find("PanelProgress/ProgressBg/ImgProgress"):GetComponent(typeof(CS.UnityEngine.UI.Image))
