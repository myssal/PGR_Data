...
function XUiGridIdleCharacter:AutoInitUi()
    ...
    self.BtnCondition = self.Transform:Find("PanelCondition/BtnCondition"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtCondition = self.Transform:Find("PanelCondition/TxtCondition"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelVitality = self.Transform:Find("PanelVitality")
    self.TxtVitality = self.Transform:Find("PanelVitality/TxtVitality"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelInSlot = self.Transform:Find("PanelInSlot")
    self.ImgInSlot = self.Transform:Find("PanelInSlot/ImgInSlot"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtInSlot = self.Transform:Find("PanelInSlot/TxtInSlot"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.ImgWorking = self.Transform:Find("PanelTag/ImgWorking"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgSelect = self.Transform:Find("ImgSelect"):GetComponent(typeof(CS.UnityEngine.UI.Image))
end
