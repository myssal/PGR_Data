...
function XUiPanelSupport:AutoInitUi()
    ...
    self.TxtName = self.Transform:Find("PanelInfo/PanelHaveData/TxtName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ImgRoleQulity = self.Transform:Find("PanelInfo/PanelHaveData/ImgRoleQulity"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgIcon = self.Transform:Find("PanelInfo/PanelHaveData/ImgIcon"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtLevel = self.Transform:Find("PanelInfo/PanelHaveData/TxtLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelNoData = self.Transform:Find("PanelInfo/PanelNoData")
    self.ImgMedalNone = self.Transform:Find("PanelInfo/PanelNoData/ImgMedalNone"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.PanelMedal = self.Transform:Find("PanelMedal")
    self.ImgMedal = self.Transform:Find("PanelMedal/ImgMedal"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgMedalNoneA = self.Transform:Find("PanelMedal/ImgMedalNone"):GetComponent(typeof(CS.UnityEngine.UI.Image))
end
