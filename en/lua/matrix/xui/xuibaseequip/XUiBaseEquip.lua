...
function XUiBaseEquip:AutoInitUi()
    ...
    self.BtnPart1 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart1"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgRedPoint1 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart1/ImgRedPoint1"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnPart2 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart2"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgRedPoint2 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart2/ImgRedPoint2"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnPart3 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart3"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgRedPoint3 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart3/ImgRedPoint3"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnPart4 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart4"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgRedPoint4 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart4/ImgRedPoint4"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnPart5 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart5"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgRedPoint5 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart5/ImgRedPoint5"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnPart6 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart6"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgRedPoint6 = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnPart6/ImgRedPoint6"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    ...
    self.BtnBack = self.Transform:Find("SafeAreaContentPane/PanelTopButton/BtnBack"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnMainUi = self.Transform:Find("SafeAreaContentPane/PanelTopButton/BtnMainUi"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
