...
---@class XUiGridGachaLiv4P5ShowReward : XUiNode
---@field Parent XUiGachaLiv4P5Show
local XUiGridGachaLiv4P5ShowReward = XClass(XUiNode, "XUiGridGachaLiv4P5ShowReward")

local LineEffect2d = "DrawShowLineCommunicationEffect2d"

function XUiGridGachaLiv4P5ShowReward:OnStart(uiPanel, farCamera, nearCamera, uiCamera)
...
function XUiGridGachaLiv4P5ShowReward:InitUiObject()
...
function XUiGridGachaLiv4P5ShowReward:OnShow(rewardInfo)
...
function XUiGridGachaLiv4P5ShowReward:OnShowEnd()
...
function XUiGridGachaLiv4P5ShowReward:CreateModel(id, rewardType)
...
function XUiGridGachaLiv4P5ShowReward:CreateWeaponModel(templateId)
...
function XUiGridGachaLiv4P5ShowReward:CreateWeaponFashionModel(templateId)
...
function XUiGridGachaLiv4P5ShowReward:CreateCharacterModel(templateId, fashionId)
...
function XUiGridGachaLiv4P5ShowReward:CreatePartnerModel(templateId)
...
function XUiGridGachaLiv4P5ShowReward:CreateItem(iconPath, isSmall, type)
...
function XUiGridGachaLiv4P5ShowReward:LoadEffect(id)
    -- 加载底座特效
...
function XUiGridGachaLiv4P5ShowReward:OnDestroy()

end

return XUiGridGachaLiv4P5ShowReward