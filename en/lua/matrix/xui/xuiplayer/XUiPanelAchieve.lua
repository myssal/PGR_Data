...
function XUiPanelAchieve:AutoInitUi()
    ...
    self.ImgAchvUnactive = self.Transform:Find("GroupTop/TogFight/ImgAchvUnactive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgAchvActive = self.Transform:Find("GroupTop/TogFight/ImgAchvActive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgRedFight = self.Transform:Find("GroupTop/TogFight/ImgRedFight"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TogCollect = self.Transform:Find("GroupTop/TogCollect"):GetComponent("Toggle")
    self.ImgCollvUnActive = self.Transform:Find("GroupTop/TogCollect/ImgCollvUnActive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCollvActive = self.Transform:Find("GroupTop/TogCollect/ImgCollvActive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgRedCollect = self.Transform:Find("GroupTop/TogCollect/ImgRedCollect"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TogSocial = self.Transform:Find("GroupTop/TogSocial"):GetComponent("Toggle")
    self.ImgSocUnactive = self.Transform:Find("GroupTop/TogSocial/ImgSocUnactive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgSocActive = self.Transform:Find("GroupTop/TogSocial/ImgSocActive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgRedSocial = self.Transform:Find("GroupTop/TogSocial/ImgRedSocial"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TogOther = self.Transform:Find("GroupTop/TogOther"):GetComponent("Toggle")
    self.ImgOthUnactive = self.Transform:Find("GroupTop/TogOther/ImgOthUnactive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgOthActive = self.Transform:Find("GroupTop/TogOther/ImgOthActive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgRedOther = self.Transform:Find("GroupTop/TogOther/ImgRedOther"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    ...
    self.TxtAchvGetCount = self.Transform:Find("PanelAchvReach/TxtAchvGetCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
end
