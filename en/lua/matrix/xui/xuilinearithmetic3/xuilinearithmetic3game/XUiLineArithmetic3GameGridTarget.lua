--[[
-- XUiLineArithmetic3GameGridTarget.lua
-- Auto generated by XUiLuaCodeGenerator
-- Generated at: 2026-02-03 19:58:14
--]]

---@class XUiLineArithmetic3GameGridTarget : XUiNode
...
local XUiLineArithmetic3GameGridTarget = XClass(XUiNode, "XUiLineArithmetic3GameGridTarget")

--- 更新目标数据
---@param data XLineArithmetic3ControlDataStarDesc
function XUiLineArithmetic3GameGridTarget:Update(data)
...
return XUiLineArithmetic3GameGridTarget
