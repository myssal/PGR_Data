...
function XChar8005:UpdateComboSkillSafeProtection()
    ...
    self:ProtectComboSkill(curActionId, 1000497, 1000498, {8005300, 8005301, 8005518, 8055519}, false)
    self:ProtectComboSkill(curActionId, 1000465, 1000466, {8005298, 8005299, 8005300, 8005301, 8005518, 8005519}, false)
    self:ProtectComboSkill(curActionId, 1000467, 1000468, {8005298, 8005299, 8005300, 8005301, 8005518, 8005519}, false)
    self:ProtectComboSkill(curActionId, 1000469, 1000470, {8005298, 8005299, 8005300, 8005301, 8005518, 8005519}, false)
    self:ProtectComboSkill(curActionId, self._immuUltraAbortMagicId, self._cancelImmuUltraAbortMagicId, {8005298, 8005299, 8005300, 8005301, 8005518, 8005519}, false)
...
function XChar8005:OnNpcRemoveBuffEvent(casterNpcUUID, npcUUID, buffId, buffKinds, buffUUId)
    ...
    if buffId == 8005070 then
        if self._proxy:GetNpcProtector(self._uuid) <= 0 then
            ...
            self:SetSyncVar(self._syncKeys.curComboId, 1)
            -- 强制关闭机制条
            self._proxy:HideMechanismBar(3)
            -- 失败语音
