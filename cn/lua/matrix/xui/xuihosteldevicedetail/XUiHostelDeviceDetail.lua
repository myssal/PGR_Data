...
function XUiHostelDeviceDetail:AutoInitUi()
    ...
    self.BtnShowInfo = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/PanelBtnInfo/BtnShowInfo"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.TxtFunctionDeviceName = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/ContentInfo/PanelSysInfo/PanelFixInfo/TxtFunctionDeviceName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtSysDes = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/ContentInfo/PanelSysDes/TxtSysDes"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelUpInfo = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/PanelUpInfo")
    self.ImgCost = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/PanelUpInfo/ImgCost"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtCostCount = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/PanelUpInfo/TxtCostCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCostTime = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/PanelUpInfo/TxtCostTime"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnIntoUpgrade = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/BtnIntoUpgrade"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnQuest = self.Transform:Find("SafeAreaContentPane/PanelDeviceUpgradeMain/BtnQuest"):GetComponent(typeof(CS.UnityEngine.UI.Button))
...
function XUiHostelDeviceDetail:UpdateView()
    ...
    local rectTf = self.PanelBtnInfo.gameObject:GetComponent(typeof(CS.UnityEngine.RectTransform))
