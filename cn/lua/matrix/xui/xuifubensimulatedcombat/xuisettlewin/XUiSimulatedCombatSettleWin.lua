...
function XUiSimulatedCombatSettleWin:AutoInitUi()
    ...
    self.TxtAssist = self.Transform:Find("SafeAreaContentPane/PanelNorWinInfo/PanelNor/PanelRight/PanelAssist/TxtAssist"):GetComponent(typeof(CS.UnityEngine.UI.Text))
end
