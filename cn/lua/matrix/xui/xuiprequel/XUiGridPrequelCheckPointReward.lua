...
function XUiGridPrequelCheckPointReward:AutoInitUi()
    self.TxtOrder = self.Transform:Find("TxtOrder"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtTaskName = self.Transform:Find("TxtTaskName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.RImgIcon = self.Transform:Find("PanelRewardContent/GridCommon/RImgIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.ImgQuality = self.Transform:Find("PanelRewardContent/GridCommon/ImgQuality"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnClick = self.Transform:Find("PanelRewardContent/GridCommon/BtnClick"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtCount = self.Transform:Find("PanelRewardContent/GridCommon/TxtCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnFinish = self.Transform:Find("BtnFinish"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgAlreadyFinish = self.Transform:Find("ImgAlreadyFinish"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgUnFinish = self.Transform:Find("ImgUnFinish"):GetComponent(typeof(CS.UnityEngine.UI.Image))
end
