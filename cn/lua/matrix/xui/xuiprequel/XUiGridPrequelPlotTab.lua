...
function XUiGridPrequelPlotTab:AutoInitUi()
    ...
    self.ImgUnSelectA = self.Transform:Find("PanelTabLock/ImgUnSelect"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgLock = self.Transform:Find("PanelTabLock/ImgLock"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtLockTitle = self.Transform:Find("PanelTabLock/TxtLockTitle"):GetComponent(typeof(CS.UnityEngine.UI.Text))
