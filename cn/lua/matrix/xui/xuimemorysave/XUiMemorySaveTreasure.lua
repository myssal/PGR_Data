...
function XUiMemorySaveTreasure:AutoInitUi()
    self.ImgGradeLine = self.Transform:Find("ImgGradeLine"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtGrade = self.Transform:Find("TxtGrade"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtGradeStarNums = self.Transform:Find("TxtGradeStarNums"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ImgGradeStarActive = self.Transform:Find("ImgGradeStarActive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgGradeStarUnactive = self.Transform:Find("ImgGradeStarUnactive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnReceive = self.Transform:Find("BtnReceive"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.ImgCannotReceive = self.Transform:Find("ImgCannotReceive"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgAlreadyReceived = self.Transform:Find("ImgAlreadyReceived"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    ...
    self.RImgIcon = self.Transform:Find("PanelTreasureList/Viewport/PanelTreasureContent/GridCommon/RImgIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.ImgQuality = self.Transform:Find("PanelTreasureList/Viewport/PanelTreasureContent/GridCommon/ImgQuality"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnClick = self.Transform:Find("PanelTreasureList/Viewport/PanelTreasureContent/GridCommon/BtnClick"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtCount = self.Transform:Find("PanelTreasureList/Viewport/PanelTreasureContent/GridCommon/TxtCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelMultipleWeeksJindu = self.Transform:Find("PanelMultipleWeeksJindu")
    self.TxtTaskDescribe = self.Transform:Find("PanelMultipleWeeksJindu/TxtTaskDescribe"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtTaskNumQian = self.Transform:Find("PanelMultipleWeeksJindu/TxtTaskNumQian"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ProgressBg  = self.Transform:Find("PanelMultipleWeeksJindu/ProgressBg")
    self.ImgProgress = self.Transform:Find("PanelMultipleWeeksJindu/ProgressBg/ImgProgress"):GetComponent(typeof(CS.UnityEngine.UI.Image))
