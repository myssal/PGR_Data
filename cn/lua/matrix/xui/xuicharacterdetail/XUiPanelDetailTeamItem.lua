...
function XUiPanelDetailTeamItem:AutoInitUi()
    ...
    self.TxtName1 = self.Transform:Find("layout/PanelCharItem1/TxtName1"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.RImgQuality1 = self.Transform:Find("layout/PanelCharItem1/RImgQuality1"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.PanelCharItem2 = self.Transform:Find("layout/PanelCharItem2")
    self.TxtName2 = self.Transform:Find("layout/PanelCharItem2/TxtName2"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.RImgQuality2 = self.Transform:Find("layout/PanelCharItem2/RImgQuality2"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.PanelCharItem3 = self.Transform:Find("layout/PanelCharItem3")
    self.TxtName3 = self.Transform:Find("layout/PanelCharItem3/TxtName3"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.RImgQuality3 = self.Transform:Find("layout/PanelCharItem3/RImgQuality3"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
