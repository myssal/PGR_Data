...
---@class XUiGachaLiv4P5QuickWear : XLuaUi 使用历程奖励弹框
local XUiGachaLiv4P5QuickWear = XLuaUiManager.Register(XLuaUi, "UiGachaLifu405QuickWear")

function XUiGachaLiv4P5QuickWear:OnAwake()
    XUiHelper.RegisterClickEvent(self, self.BtnClose, self.Close)
    XUiHelper.RegisterClickEvent(self, self.BtnWear, self.OnBtnWearClick)
end

function XUiGachaLiv4P5QuickWear:OnStart(templateId, rewardId, isConvertFrom, rewardName, callBack)
...
function XUiGachaLiv4P5QuickWear:Close()
...
function XUiGachaLiv4P5QuickWear:OnBtnWearClick()
...
return XUiGachaLiv4P5QuickWear