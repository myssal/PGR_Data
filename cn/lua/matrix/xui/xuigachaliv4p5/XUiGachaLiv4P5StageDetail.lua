...
---@class XUiGachaLiv4P5StageDetail : XLuaUi
local XUiGachaLiv4P5StageDetail = XLuaUiManager.Register(XLuaUi, "UiGachaLifu405StageDetail")

function XUiGachaLiv4P5StageDetail:OnAwake()
    ---@type XUiGridCommon[]
    self._GridList = {}
...
function XUiGachaLiv4P5StageDetail:OnStart(stageId)
...
function XUiGachaLiv4P5StageDetail:OnEnable()
...
function XUiGachaLiv4P5StageDetail:PlayStoryId(movieId)
    XDataCenter.MovieManager.PlayMovie(movieId)
end

function XUiGachaLiv4P5StageDetail:OnBtnEnterClick()
    local stageCfg = self._StageCfg
...
return XUiGachaLiv4P5StageDetail