---@class XUiGachaLiv4P5Tip : XLuaUi
local XUiGachaLiv4P5Tip = XLuaUiManager.Register(XLuaUi, "UiGachaLifu405Tip")

local type = type

function XUiGachaLiv4P5Tip:OnAwake()
    self:InitAutoScript()
end

function XUiGachaLiv4P5Tip:OnStart(data, hideSkipBtn, rootUiName, lackNum, showNum, switchRainbowCard, title, isShowCount)
...
function XUiGachaLiv4P5Tip:OnEnable()
    self:Refresh(self.Data)
end

function XUiGachaLiv4P5Tip:OnDisable()

end

function XUiGachaLiv4P5Tip:OnDestroy()

end

function XUiGachaLiv4P5Tip:ShowCurrentRainbowCard()
...
function XUiGachaLiv4P5Tip:InitAutoScript()
    self.SpecialSoundMap = {}
    self:AutoAddListener()
end

function XUiGachaLiv4P5Tip:GetAutoKey(uiNode, eventName)
    if not uiNode then
        return
    end
...
function XUiGachaLiv4P5Tip:RegisterListener(uiNode, eventName, func)
...
function XUiGachaLiv4P5Tip:AutoAddListener()
...
-- auto
function XUiGachaLiv4P5Tip:OnBtnBackClick()
    self:Close()
end

function XUiGachaLiv4P5Tip:OnBtnGetClick()
    XLuaUiManager.Open("UiSkip", self.TemplateId, function()
        self:Close()
    end, self.HideSkipBtn)
end

function XUiGachaLiv4P5Tip:OnBtnOkClick()
    self:Close()
end

function XUiGachaLiv4P5Tip:OnBtnTcanchaungBlackClick()
...
function XUiGachaLiv4P5Tip:OnBtnActionClick()
...
function XUiGachaLiv4P5Tip:SetUiActive(ui, active)
...
function XUiGachaLiv4P5Tip:ResetUi()
...
function XUiGachaLiv4P5Tip:Refresh(data)
    self.Data = data
    if not data then
...
--===============
function XUiGachaLiv4P5Tip:SetTempData(data)
    -- 名称
...
function XUiGachaLiv4P5Tip:OnGetEvents()
    return {
        XEventId.EVENT_ITEM_FAST_TRADING
    }
end

function XUiGachaLiv4P5Tip:OnNotify(evt, ...)
