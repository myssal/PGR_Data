...
function XUiGachaLiv4P5Show:OnStart(gachaId, rewardList, state, isSkip)
...
function XUiGachaLiv4P5Show:OnEnable()
...
function XUiGachaLiv4P5Show:OnDisable()
    self:StopCv()
end

function XUiGachaLiv4P5Show:OnDestroy()
    self:StopCv()
...
function XUiGachaLiv4P5Show:RegisterButton()
...
function XUiGachaLiv4P5Show:InitUi()
    self._FarCameraList = {}
...
function XUiGachaLiv4P5Show:PlayNext()
    ...
    if not self._LastReward then
        ...
        self._GridRewardList[self._CurrIndex] = require("XUi/XUiGachaLiv4P5/Grid/XUiGridGachaLiv4P5ShowReward").New(self._ModelPanelList[self._CurrIndex], self, self._UiPanelList[self._CurrIndex], self._FarCameraList[self._CurrIndex], self._NearCameraList[self._CurrIndex], self._UiCameraList[self._CurrIndex])
        self._LastReward = self._GridRewardList[self._CurrIndex]
    end
...
function XUiGachaLiv4P5Show:ShowResult()
...
function XUiGachaLiv4P5Show:RefreshByState()
...
function XUiGachaLiv4P5Show:SetDrawEffectGroupId(effectGroupId)
    if effectGroupId > self._MaxEffectGroupId then
        self._MaxEffectGroupId = effectGroupId
    end
end

function XUiGachaLiv4P5Show:PlayCardEffectSound()
...
function XUiGachaLiv4P5Show:StopCv()
    if self._CvInfo then
        self._CvInfo:Stop()
        self._CvInfo = nil
    end
end
function XUiGachaLiv4P5Show:OnBtnSkipClick()
    if self._CurrState == DrawState.Result then
        self:Close()
    else
        self._CurrState = DrawState.Result
