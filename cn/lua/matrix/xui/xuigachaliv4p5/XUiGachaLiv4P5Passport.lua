---@class XUiGachaLiv4P5Passport : XLuaUi 使用皮肤和场景弹框
local XUiGachaLiv4P5Passport = XLuaUiManager.Register(XLuaUi, "UiGachaLifu405Passport")

function XUiGachaLiv4P5Passport:OnAwake()
...
function XUiGachaLiv4P5Passport:OnStart(reward, callBack)
...
function XUiGachaLiv4P5Passport:Close()
...
function XUiGachaLiv4P5Passport:OnWear()
...
function XUiGachaLiv4P5Passport:OnSetAssistant()
    self.BtnSetAssistant.gameObject:SetActiveEx(false)
