...
function XUiHostelDelegate:AutoInitUi()
    ...
    self.BtnTab1 = self.Transform:Find("SafeAreaContentPane/PanelLeft/ScrollView/Viewport/PanelTabGroup/BtnTab1"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtNormal = self.Transform:Find("SafeAreaContentPane/PanelLeft/ScrollView/Viewport/PanelTabGroup/BtnTab1/TxtNormal"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtSelected = self.Transform:Find("SafeAreaContentPane/PanelLeft/ScrollView/Viewport/PanelTabGroup/BtnTab1/TxtSelected"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelReport = self.Transform:Find("SafeAreaContentPane/PanelLeft/PanelReport")
    self.BtnReport = self.Transform:Find("SafeAreaContentPane/PanelLeft/PanelReport/BtnReport"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtReleaseCount = self.Transform:Find("SafeAreaContentPane/PanelLeft/PanelReport/TxtReleaseCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCompleteCount = self.Transform:Find("SafeAreaContentPane/PanelLeft/PanelReport/TxtCompleteCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtDesc = self.Transform:Find("SafeAreaContentPane/PanelContent/TxtDesc"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ImgRewardIcon = self.Transform:Find("SafeAreaContentPane/PanelContent/ImgRewardIcon"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtRewardCount = self.Transform:Find("SafeAreaContentPane/PanelContent/TxtRewardCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.BtnAdd = self.Transform:Find("SafeAreaContentPane/PanelBottom/PanelRelease/BtnAdd"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnMinus = self.Transform:Find("SafeAreaContentPane/PanelBottom/PanelRelease/BtnMinus"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtCount = self.Transform:Find("SafeAreaContentPane/PanelBottom/PanelRelease/TxtCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnRelease = self.Transform:Find("SafeAreaContentPane/PanelBottom/PanelRelease/BtnRelease"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtRemainCount = self.Transform:Find("SafeAreaContentPane/PanelBottom/PanelRelease/TxtRemainCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelMission = self.Transform:Find("SafeAreaContentPane/PanelBottom/PanelMission")
    self.BtnCancel = self.Transform:Find("SafeAreaContentPane/PanelBottom/PanelMission/BtnCancel"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnHelp = self.Transform:Find("SafeAreaContentPane/PanelBottom/PanelMission/BtnHelp"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
