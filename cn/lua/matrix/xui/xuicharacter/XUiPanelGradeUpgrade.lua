...
function XUiPanelGradeUpgrade:AutoInitUi()
    self.RImgCharacterIcon = self.Transform:Find("BgImage/RImgCharacterIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.TxtName = self.Transform:Find("BgImage/RImgCharacterIcon/TxtName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnDarkBg = self.Transform:Find("BtnDarkBg"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelCharAttack = self.Transform:Find("BgImage/Properties/PanelCharAttack")
    self.TxtOldBattlePower = self.Transform:FindTransform("TxtOldBattlePower"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurBattlePower = self.Transform:FindTransform("TxtCurBattlePower"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtOldAttack = self.Transform:Find("BgImage/Properties/PanelCharAttack/TxtOldAttack"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurAttack = self.Transform:Find("BgImage/Properties/PanelCharAttack/TxtCurAttack"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelCharLife = self.Transform:Find("BgImage/Properties/PanelCharLife")
    self.TxtOldLife = self.Transform:Find("BgImage/Properties/PanelCharLife/TxtOldLife"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurLife = self.Transform:Find("BgImage/Properties/PanelCharLife/TxtCurLife"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelCharDefense = self.Transform:Find("BgImage/Properties/PanelCharDefense")
    self.TxtOldDefense = self.Transform:Find("BgImage/Properties/PanelCharDefense/TxtOldDefense"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurDefense = self.Transform:Find("BgImage/Properties/PanelCharDefense/TxtCurDefense"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelCharCrit = self.Transform:Find("BgImage/Properties/PanelCharCrit")
    self.TxtOldCrit = self.Transform:Find("BgImage/Properties/PanelCharCrit/TxtOldCrit"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurCrit = self.Transform:Find("BgImage/Properties/PanelCharCrit/TxtCurCrit"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelGradeB = self.Transform:Find("BgImage/PanelGrade")
    self.RImgOldIconTitleA = self.Transform:Find("BgImage/PanelGrade/RImgOldIconTitle"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.RImgCurIconTitleA = self.Transform:Find("BgImage/PanelGrade/RImgCurIconTitle"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.PanelOldStarGoupA = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup")
    self.ImgOldStar1A = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup/Star1/ImgOldStar1"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgOldOnStar1A = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup/Star1/ImgOldOnStar1"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgOldStar2A = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup/Star2/ImgOldStar2"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgOldOnStar2A = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup/Star2/ImgOldOnStar2"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgOldStar3A = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup/Star3/ImgOldStar3"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgOldOnStar3A = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup/Star3/ImgOldOnStar3"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgOldStar4A = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup/Star4/ImgOldStar4"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgOldOnStar4A = self.Transform:Find("BgImage/PanelGrade/PanelOldStarGoup/Star4/ImgOldOnStar4"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.PanelCurStarGoupA = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup")
    self.ImgCurStar1A = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup/Star1/ImgCurStar1"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCurOnStar1A = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup/Star1/ImgCurOnStar1"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCurStar2A = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup/Star2/ImgCurStar2"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCurOnStar2A = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup/Star2/ImgCurOnStar2"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCurStar3A = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup/Star3/ImgCurStar3"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCurOnStar3A = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup/Star3/ImgCurOnStar3"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCurStar4A = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup/Star4/ImgCurStar4"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCurOnStar4A = self.Transform:Find("BgImage/PanelGrade/PanelCurStarGoup/Star4/ImgCurOnStar4"):GetComponent(typeof(CS.UnityEngine.UI.Image))
end
