...
function XUiPanelRewardBox:AutoInitUi()
    ...
    self.ImgDefault = self.Transform:Find("PanelBox/Panel_Lock/ImgDefault"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnOpen = self.Transform:Find("PanelBox/Panel_Lock/BtnOpen"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelRewards = self.Transform:Find("PanelBox/PanelRewards")
    self.TxtName = self.Transform:Find("PanelBox/PanelRewards/TxtName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
