...
function XUiFubenStageDetail:AutoInitUi()
    ...
    self.ImgStarB = self.Transform:Find("SafeAreaContentPane/PanelTargetList/GridStar3/ImgStar"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.GridStar2 = self.Transform:Find("SafeAreaContentPane/PanelTargetList/GridStar2")
    self.ImgStarA = self.Transform:Find("SafeAreaContentPane/PanelTargetList/GridStar2/ImgStar"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtStarActiveB = self.Transform:Find("SafeAreaContentPane/PanelTargetList/GridStar2/TxtStarActive"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.GridStar1 = self.Transform:Find("SafeAreaContentPane/PanelTargetList/GridStar1")
    self.ImgStar = self.Transform:Find("SafeAreaContentPane/PanelTargetList/GridStar1/ImgStar"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    ...
    self.TxtAllNums = self.Transform:Find("SafeAreaContentPane/PanelNums/TxtAllNums"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnAddNum = self.Transform:Find("SafeAreaContentPane/PanelNums/BtnAddNum"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtLeftNums = self.Transform:Find("SafeAreaContentPane/PanelNums/TxtLeftNums"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelDesc = self.Transform:Find("SafeAreaContentPane/PanelDesc")
    self.RImgNandu = self.Transform:Find("SafeAreaContentPane/PanelDesc/RImgNandu"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    ...
    self.BtnEnter = self.Transform:Find("SafeAreaContentPane/PanelBottom/BtnEnter"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnRepeatEnter = self.Transform:Find("SafeAreaContentPane/PanelBottom/BtnRepeatEnter"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
