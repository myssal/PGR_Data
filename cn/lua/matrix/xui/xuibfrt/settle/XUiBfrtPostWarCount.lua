...
function XUiBfrtPostWarCount:AutoInitUi()
    ...
    self.BtnNextStage = self.Transform:Find("SafeAreaContentPane/BtnNextStage"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnExit = self.Transform:Find("SafeAreaContentPane/BtnExit"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.ImgExp = self.Transform:Find("SafeAreaContentPane/PanelPlayer/ImgExp"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtAddExp = self.Transform:Find("SafeAreaContentPane/PanelPlayer/TxtAddExp"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtLevelA = self.Transform:Find("SafeAreaContentPane/PanelPlayer/TxtLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtLevelName = self.Transform:Find("SafeAreaContentPane/PanelPlayer/TxtLevelName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
end
