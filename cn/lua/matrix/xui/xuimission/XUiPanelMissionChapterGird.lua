...
function XUiPanelMissionChapterGird:AutoInitUi()
    ...
    -- self.ImgChapter = self.Transform:Find("PanelChapterSlect/ImgChapter"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.RImgIcon = self.Transform:Find("PanelChapterSlect/ImgChapter/RImgIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    -- self.PanelTxt = self.Transform:Find("PanelChapterSlect/PanelTxt")
    -- self.Txt1 = self.Transform:Find("PanelChapterSlect/PanelTxt/Txt1"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.Txt2 = self.Transform:Find("PanelChapterSlect/PanelTxt/Txt2"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.Txt3 = self.Transform:Find("PanelChapterSlect/PanelTxt/Txt3"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.TxtName = self.Transform:Find("PanelChapterSlect/TxtName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.PanelChapterHave = self.Transform:Find("PanelChapterHave")
    -- self.ImgChapterA = self.Transform:Find("PanelChapterHave/ImgChapter"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.RImgIconA = self.Transform:Find("PanelChapterHave/ImgChapter/RImgIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    -- self.PanelTxtA = self.Transform:Find("PanelChapterHave/PanelTxt")
    -- self.Txt1A = self.Transform:Find("PanelChapterHave/PanelTxt/Txt1"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.Txt2A = self.Transform:Find("PanelChapterHave/PanelTxt/Txt2"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.Txt3A = self.Transform:Find("PanelChapterHave/PanelTxt/Txt3"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.TxtNameA = self.Transform:Find("PanelChapterHave/TxtName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.PanelChapterLock = self.Transform:Find("PanelChapterLock")
    -- self.ImgLock = self.Transform:Find("PanelChapterLock/ImgLock"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.Txt1B = self.Transform:Find("PanelChapterLock/Txt1"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.TxtNameB = self.Transform:Find("PanelChapterLock/TxtName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
end
