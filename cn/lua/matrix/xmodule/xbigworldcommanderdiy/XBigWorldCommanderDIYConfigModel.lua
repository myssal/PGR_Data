...
function XBigWorldCommanderDIYConfigModel:GetDlcPlayerFashionPartIsSuitPartById(id)
    local config = self:GetDlcPlayerFashionPartConfigById(id)
...
function XBigWorldCommanderDIYConfigModel:GetDlcPlayerFashionPartConvertItemIdById(id)
    local config = self:GetDlcPlayerFashionPartConfigById(id)

    return config.ConvertItemId
end

function XBigWorldCommanderDIYConfigModel:GetDlcPlayerFashionPartConvertItemCountById(id)
    local config = self:GetDlcPlayerFashionPartConfigById(id)

    return config.ConvertItemCount
end
...
function XBigWorldCommanderDIYConfigModel:GetDlcPlayerFashionTypeIsSuitByTypeId(typeId)
    local config = self:GetDlcPlayerFashionTypeConfigByTypeId(typeId)
