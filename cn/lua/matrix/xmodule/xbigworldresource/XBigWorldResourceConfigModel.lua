...
function XBigWorldResourceConfigModel:GetDlcUiModelNodeControlConfigs()
    return self._ConfigUtil:GetByTableKey(DlcResourceTableKey.BigWorldUiModelNodeControl) or {}
end
