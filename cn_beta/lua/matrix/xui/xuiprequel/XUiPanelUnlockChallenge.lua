...
function XUiPanelUnlockChallenge:AutoInitUi()
    self.ImgMask = self.Transform:Find("ImgMask"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.PanelMain = self.Transform:Find("PanelMain")
    self.TxtUnlockTitle = self.Transform:Find("PanelMain/TxtUnlockTitle"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelInfo = self.Transform:Find("PanelMain/PanelInfo")
    self.TxtTitle = self.Transform:Find("PanelMain/PanelInfo/TxtTitle"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCheckPoint = self.Transform:Find("PanelMain/PanelInfo/TxtCheckPoint"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.RImgCheckPoint = self.Transform:Find("PanelMain/PanelInfo/RImgCheckPoint"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.GridCommon = self.Transform:Find("PanelMain/RewardListList/Viewport/Content/GridCommon")
    self.RImgIcon = self.Transform:Find("PanelMain/RewardListList/Viewport/Content/GridCommon/RImgIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.PanelChallengeTimes = self.Transform:Find("PanelMain/PanelChallengeTimes")
    self.TxtChallengeTimes = self.Transform:Find("PanelMain/PanelChallengeTimes/TxtChallengeTimes"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelCost = self.Transform:Find("PanelMain/PanelCost")
    self.PanelMoney = self.Transform:Find("PanelMain/PanelCost/PanelMoney")
    self.RImgCost = self.Transform:Find("PanelMain/PanelCost/PanelMoney/RImgCost"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.TxtCostNum = self.Transform:Find("PanelMain/PanelCost/PanelMoney/TxtCostNum"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnUnlock = self.Transform:Find("PanelMain/PanelCost/BtnUnlock"):GetComponent(typeof(CS.UnityEngine.UI.Button))
