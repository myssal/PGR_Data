...
function XUiPanelEnterFightDialog:AutoInitUi()
    self.BtnMaskB = self.Transform:Find("BtnMask"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelStory = self.Transform:Find("PanelStory")
    self.TxtStoryName = self.Transform:Find("PanelStory/TxtStoryName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtStoryDec = self.Transform:Find("PanelStory/TxtStoryDec"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.RImgStory = self.Transform:Find("PanelStory/RImgStory"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.BtnEnterStory = self.Transform:Find("PanelStory/BtnEnterStory"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelFight = self.Transform:Find("PanelFight")
    self.TxtFightName = self.Transform:Find("PanelFight/TxtFightName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtFightDec = self.Transform:Find("PanelFight/TxtFightDec"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.RImgFight = self.Transform:Find("PanelFight/RImgFight"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.BtnEnterFight = self.Transform:Find("PanelFight/BtnEnterFight"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
