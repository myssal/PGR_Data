...
function XUiPanelChallengeMode:AutoInitUi()
    ...
    self.BtnDetailMask = self.Transform:Find("PanelMode/BtnDetailMask"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelPrequelStages = self.Transform:Find("PanelMode/PanelPrequelStages")
    self.TxtMode = self.Transform:Find("PanelMode/PanelBt/TxtMode"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.BtnSwitch2Regional = self.Transform:Find("PanelMode/PanelBt/BtnSwitch2Regional"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelShop = self.Transform:Find("PanelMode/PanelShop")
    self.BtnShop = self.Transform:Find("PanelMode/PanelShop/BtnShop"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.TxtResetTime = self.Transform:Find("PanelMode/PanelReset/PanelCenter/TxtResetTime"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelOpenItem = self.Transform:Find("PanelMode/PanelOpenItem")
    self.TxtTotalNum = self.Transform:Find("PanelMode/PanelOpenItem/TxtTotalNum"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.RImgCostIcon = self.Transform:Find("PanelMode/PanelOpenItem/RImgCostIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.BtnActDesc = self.Transform:Find("PanelMode/BtnActDesc"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtChapterName = self.Transform:Find("PanelMode/PanelBt/TxtChapterName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
end
