...
function XUiPanelBaseEquipPutOn:AutoInitUi()
    ...
    self.TxtPart = self.Transform:Find("PanelPart/PanelEmpty/TxtPart"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtDesc = self.Transform:Find("PanelPart/PanelEmpty/TxtDesc"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnEquipInfo = self.Transform:Find("PanelPart/BtnEquipInfo"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.ImgNew1 = self.Transform:Find("PanelTogglePos/Toggle1/ImgNew1"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.Toggle2 = self.Transform:Find("PanelTogglePos/Toggle2"):GetComponent("Toggle")
    self.ImgNew2 = self.Transform:Find("PanelTogglePos/Toggle2/ImgNew2"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.Toggle3 = self.Transform:Find("PanelTogglePos/Toggle3"):GetComponent("Toggle")
    self.ImgNew3 = self.Transform:Find("PanelTogglePos/Toggle3/ImgNew3"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.Toggle4 = self.Transform:Find("PanelTogglePos/Toggle4"):GetComponent("Toggle")
    self.ImgNew4 = self.Transform:Find("PanelTogglePos/Toggle4/ImgNew4"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.Toggle5 = self.Transform:Find("PanelTogglePos/Toggle5"):GetComponent("Toggle")
    self.ImgNew5 = self.Transform:Find("PanelTogglePos/Toggle5/ImgNew5"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.Toggle6 = self.Transform:Find("PanelTogglePos/Toggle6"):GetComponent("Toggle")
    self.ImgNew6 = self.Transform:Find("PanelTogglePos/Toggle6/ImgNew6"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    ...
    self.BtnPutOn = self.Transform:Find("BtnPutOn"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtEmptyTip = self.Transform:Find("TxtEmptyTip"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCapacity = self.Transform:Find("TxtCapacity"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCoinNum = self.Transform:Find("TxtCoinNum"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelPutOnShowTip = self.Transform:Find("PanelPutOnShowTip")
    self.BtnRecycle = self.Transform:Find("BtnRecycle"):GetComponent(typeof(CS.UnityEngine.UI.Button))
