...
function XUiFubenMainLineBanner:AutoInitUi()
    ...
    self.BtnCloseDifficult = self.Transform:Find("FullScreenBackground/MainLineChapter3d/BtnCloseDifficult"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelTopDifficult = self.Transform:Find("FullScreenBackground/MainLineChapter3d/PanelTopDifficult")
    self.BtnNormal = self.Transform:Find("FullScreenBackground/MainLineChapter3d/PanelTopDifficult/BtnNormal"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnHard = self.Transform:Find("FullScreenBackground/MainLineChapter3d/PanelTopDifficult/BtnHard"):GetComponent(typeof(CS.UnityEngine.UI.Button))
