...
function XUiNewRoleShow:AutoInitUi()
    ...
    self.ImgRole = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/ImgRole"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    ...
    self.TxtHeight = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelLU/TxtHeight"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtWeight = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelLU/TxtWeight"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtBWH = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelLU/TxtBWH"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelLD = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelLD")
    self.TxtAwareness = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelLD/TxtAwareness"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtActionStandard = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelLD/TxtActionStandard"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelRU = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelRU")
    self.ImgIQ = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelRU/ImgIQ"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgEQ = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelRU/ImgEQ"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgPhysical = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelRU/ImgPhysical"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgTactics = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelRU/ImgTactics"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgLeaderShip = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelRU/ImgLeaderShip"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.PanelRD = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelRD")
    self.TxtCarryDevice = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelRD/TxtCarryDevice"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelCenter = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelCenter")
    self.TxtRace = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/PanelCenter/TxtRace"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnClick = self.Transform:Find("SafeAreaContentPane/PanelRoleDetail/BtnClick"):GetComponent(typeof(CS.UnityEngine.UI.Button))
