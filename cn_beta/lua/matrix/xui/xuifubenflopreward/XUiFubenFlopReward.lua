...
function XUiFubenFlopReward:AutoInitUi()
    ...
    self.ImgCountDownBarRight = self.Transform:Find("SafeAreaContentPane/PanelBase/PanelCountDown/ImgCountDownBarRight"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgCountDownBarLeft = self.Transform:Find("SafeAreaContentPane/PanelBase/PanelCountDown/ImgCountDownBarLeft"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtDesc = self.Transform:Find("SafeAreaContentPane/PanelBase/TxtDesc"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtDifficulty = self.Transform:Find("SafeAreaContentPane/PanelBase/PanelTxt/TxtDifficulty"):GetComponent(typeof(CS.UnityEngine.UI.Text))
