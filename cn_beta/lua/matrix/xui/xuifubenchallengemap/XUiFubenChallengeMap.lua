...
function XUiFubenChallengeMap:AutoInitUi()
    ...
    self.TxtPipei = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTip/TxtPipei"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.BtnActDesc = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTitle/BtnActDesc"):GetComponent(typeof(CS.UnityEngine.UI.Button))
