...
function XUiHomeMain:AutoInitUi()
    ...
    self.BtnVisitFriend = self.Transform:Find("SafeAreaContentPane/PanelMenu/BtnVisitFriend"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnFuncArea = self.Transform:Find("SafeAreaContentPane/PanelMenu/BtnFuncArea"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnFloorOne = self.Transform:Find("SafeAreaContentPane/PanelMenu/BtnFloorOne"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnFloorTwo = self.Transform:Find("SafeAreaContentPane/PanelMenu/BtnFloorTwo"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnFloorThree = self.Transform:Find("SafeAreaContentPane/PanelMenu/BtnFloorThree"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelMain = self.Transform:Find("SafeAreaContentPane/PanelMain")
    self.BtnJumpMenu = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnJumpMenu"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnAssignChar = self.Transform:Find("SafeAreaContentPane/PanelMain/BtnAssignChar"):GetComponent(typeof(CS.UnityEngine.UI.Button))
