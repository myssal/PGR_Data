...
function XUiPanelEliminateGame:AutoInitUi()
    ...
    self.TxtTimes = self.Transform:Find("PanelScore/Text/TxtTimes"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtTimesLeft = self.Transform:Find("PanelTimes/TxtTimesLeft"):GetComponent(typeof(CS.UnityEngine.UI.Text))
