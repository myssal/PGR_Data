...
function XUiPanelPlayerInfoEx:AutoInitUi()
    ...
    self.TxtCorps = self.Transform:Find("PanelRight/PanelCorps/TxtCorps"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelInfo = self.Transform:Find("PanelRight/PanelInfo")
    self.PanelRole = self.Transform:Find("PanelRight/PanelInfo/PanelRole")
    self.BtnRoleHeadImg = self.Transform:Find("PanelRight/PanelInfo/PanelRole/BtnRoleHeadImg"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtPlayerName = self.Transform:Find("PanelRight/PanelInfo/BtnName/TxtPlayerName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnName = self.Transform:Find("PanelRight/PanelInfo/BtnName"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnCopy = self.Transform:Find("PanelRight/PanelInfo/BtnCopy"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtPlayerIdNum = self.Transform:Find("PanelRight/PanelInfo/BtnCopy/TxtPlayerIdNum"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelBirthday = self.Transform:Find("PanelRight/PanelInfo/PanelBirthday")
    self.BtnBirModify = self.Transform:Find("PanelRight/PanelInfo/PanelBirthday/BtnGenghuan"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtDate = self.Transform:Find("PanelRight/PanelInfo/PanelBirthday/TxtDate"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelSign = self.Transform:Find("PanelRight/PanelInfo/PanelSign")
    self.BtnSign = self.Transform:Find("PanelRight/PanelInfo/PanelSign/BtnSign"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtSign = self.Transform:Find("PanelRight/PanelInfo/PanelSign/BtnSign/TxtSign"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtSignSet = self.Transform:Find("PanelRight/PanelInfo/PanelSign/BtnSign/TxtSignSet"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ImgSetNameTag = self.Transform:Find("PanelRight/PanelInfo/BtnName/ImgSetNameTag"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnLogout = self.Transform:Find("PanelRight/BtnLogout"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnRole = self.Transform:Find("PanelRight/PanelZhiyuan/PanelZhiyuan/BtnRole"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.RImgAssist = self.Transform:Find("PanelRight/PanelZhiyuan/PanelZhiyuan/BtnRole/RImgAssist"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.RImgCharacterRank = self.Transform:Find("PanelRight/PanelZhiyuan/PanelZhiyuan/RImgCharacterRank"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.TxtRoleName = self.Transform:Find("PanelRight/PanelZhiyuan/PanelZhiyuan/TxtRoleName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtRoleRank = self.Transform:Find("PanelRight/PanelZhiyuan/PanelZhiyuan/TxtRoleRank"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnAssistModify = self.Transform:Find("PanelRight/PanelZhiyuan/PanelZhiyuan/BtnGenghuan"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnSignSure = self.Transform:Find("PanelSetSign/BtnSignSure"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnSignCancel = self.Transform:Find("PanelSetSign/BtnSignCancel"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.Txt = self.Transform:Find("PanelSetSign/Txt"):GetComponent(typeof(CS.UnityEngine.UI.Text))
