...
function XUiFubenCoinSkill:AutoInitUi()
    self.BtnBack = self.Transform:Find("SafeAreaContentPane/Top/BtnBack"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnMainUi = self.Transform:Find("SafeAreaContentPane/Top/BtnMainUi"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnClosePanelLevelUpTip = self.Transform:Find("SafeAreaContentPane/PanelLevelUpTip/BtnClosePanelLevelUpTip"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtChallengeLevel = self.Transform:Find("SafeAreaContentPane/PanelLevelUpTip/TxtChallengeLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtResetTime = self.Transform:Find("SafeAreaContentPane/Panel/PanelResetTime/TxtResetTime"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelTitle = self.Transform:Find("SafeAreaContentPane/Panel/PanelTitle")
    self.TxtName = self.Transform:Find("SafeAreaContentPane/Panel/PanelTitle/TxtName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtDetail = self.Transform:Find("SafeAreaContentPane/Panel/PanelTitle/TxtDetail"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtTitle = self.Transform:Find("SafeAreaContentPane/Panel/PanelChallengeLevel/TxtTitle"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtLevelNow = self.Transform:Find("SafeAreaContentPane/Panel/PanelChallengeLevel/TxtLevelNow"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtLevelBefore = self.Transform:Find("SafeAreaContentPane/Panel/PanelChallengeLevel/TxtLevelBefore"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnActDesc = self.Transform:Find("SafeAreaContentPane/Panel/BtnActDesc"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
