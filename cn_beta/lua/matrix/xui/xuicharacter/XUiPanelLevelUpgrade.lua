...
function XUiPanelLevelUpgrade:AutoInitUi()
    self.BtnBg = self.Transform:Find("BtnBg"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.RImgRoleUpgradeMsg = self.Transform:Find("BtnBg/RImgRoleUpgradeMsg"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.PanelCharAttack = self.Transform:Find("BtnBg/Properties/PanelCharAttack")
    self.TxtOldAttack = self.Transform:Find("BtnBg/Properties/PanelCharAttack/TxtOldAttack"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurAttack = self.Transform:Find("BtnBg/Properties/PanelCharAttack/TxtCurAttack"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelCharLife = self.Transform:Find("BtnBg/Properties/PanelCharLife")
    self.TxtOldLife = self.Transform:Find("BtnBg/Properties/PanelCharLife/TxtOldLife"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurLife = self.Transform:Find("BtnBg/Properties/PanelCharLife/TxtCurLife"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelCharDefense = self.Transform:Find("BtnBg/Properties/PanelCharDefense")
    self.TxtOldDefense = self.Transform:Find("BtnBg/Properties/PanelCharDefense/TxtOldDefense"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurDefense = self.Transform:Find("BtnBg/Properties/PanelCharDefense/TxtCurDefense"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelCharCrit = self.Transform:Find("BtnBg/Properties/PanelCharCrit")
    self.TxtOldCrit = self.Transform:Find("BtnBg/Properties/PanelCharCrit/TxtOldCrit"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurCrit = self.Transform:Find("BtnBg/Properties/PanelCharCrit/TxtCurCrit"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelTxtLevel = self.Transform:Find("BtnBg/PanelTxtLevel")
    self.TxtCurLevelA = self.Transform:Find("BtnBg/PanelTxtLevel/TxtCurLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtOldLevel = self.Transform:Find("BtnBg/PanelTxtLevel/TxtOldLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnDarkBg = self.Transform:Find("BtnDarkBg"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtOldBattlePower = self.Transform:Find("BtnBg/Properties/PanelCharBattlePower/TxtOldBattlePower"):GetComponent(typeof(CS.UnityEngine.UI.Text)) -- fixme 2.5等验收完恢复提交
    self.TxtCurBattlePower = self.Transform:Find("BtnBg/Properties/PanelCharBattlePower/TxtCurBattlePower"):GetComponent(typeof(CS.UnityEngine.UI.Text))
end
