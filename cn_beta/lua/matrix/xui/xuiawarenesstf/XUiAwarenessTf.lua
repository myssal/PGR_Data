...
function XUiAwarenessTf:AutoInitUi()
    ...
    self.BtnSelectMaterial1 = self.Transform:Find("SafeAreaContentPane/PanelMaterial/Material1/BtnSelectMaterial1"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnStartTf = self.Transform:Find("SafeAreaContentPane/PanelMaterial/Buttons/BtnStartTf"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnDisable = self.Transform:Find("SafeAreaContentPane/PanelMaterial/Buttons/BtnDisable"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnSelectMaterial2 = self.Transform:Find("SafeAreaContentPane/PanelMaterial/Material2/BtnSelectMaterial2"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.GridMaterial3 = self.Transform:Find("SafeAreaContentPane/PanelMaterial/Material3/GridMaterial3")
    self.BtnSelectMaterial3 = self.Transform:Find("SafeAreaContentPane/PanelMaterial/Material3/BtnSelectMaterial3"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.GridResult = self.Transform:Find("SafeAreaContentPane/Result/GridResult")
    self.ImgGirdStar1 = self.Transform:Find("SafeAreaContentPane/Result/GridResult/Stars/PaneStar1/ImgGirdStar1"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgGirdStar2 = self.Transform:Find("SafeAreaContentPane/Result/GridResult/Stars/PaneStar2/ImgGirdStar2"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgGirdStar3 = self.Transform:Find("SafeAreaContentPane/Result/GridResult/Stars/PaneStar3/ImgGirdStar3"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgGirdStar4 = self.Transform:Find("SafeAreaContentPane/Result/GridResult/Stars/PaneStar4/ImgGirdStar4"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgGirdStar5 = self.Transform:Find("SafeAreaContentPane/Result/GridResult/Stars/PaneStar5/ImgGirdStar5"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.ImgGirdStar6 = self.Transform:Find("SafeAreaContentPane/Result/GridResult/Stars/PaneStar6/ImgGirdStar6"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.TxtResultName = self.Transform:Find("SafeAreaContentPane/Result/GridResult/TxtResultName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelPos = self.Transform:Find("SafeAreaContentPane/Result/GridResult/PanelPos")
    self.TxtResultPos = self.Transform:Find("SafeAreaContentPane/Result/GridResult/PanelPos/TxtResultPos"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtResultLevel = self.Transform:Find("SafeAreaContentPane/Result/GridResult/Text/TxtResultLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.RImgResultIcon = self.Transform:Find("SafeAreaContentPane/Result/RImgResultIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    ...
    self.BtnSortUp = self.Transform:Find("SafeAreaContentPane/PanelAwarenessBag/BtnSortUp"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnConfirm = self.Transform:Find("SafeAreaContentPane/PanelAwarenessBag/BtnConfirm"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnSortDown = self.Transform:Find("SafeAreaContentPane/PanelAwarenessBag/BtnSortDown"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnCancel = self.Transform:Find("SafeAreaContentPane/PanelAwarenessBag/BtnCancel"):GetComponent(typeof(CS.UnityEngine.UI.Button))
