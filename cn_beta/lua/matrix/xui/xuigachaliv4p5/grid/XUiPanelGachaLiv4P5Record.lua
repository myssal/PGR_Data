---@class XUiPanelGachaLiv4P5Record : XUiNode
---@field Parent XUiGachaLiv4P5Log
local XUiPanelGachaLiv4P5Record = XClass(XUiNode, "XUiPanelGachaLiv4P5Record")

function XUiPanelGachaLiv4P5Record:OnStart()
    self._TypeText = {}
    self:SetTypeText()
end

function XUiPanelGachaLiv4P5Record:SetTypeText()
...
function XUiPanelGachaLiv4P5Record:RefreshUiShow(gachaConfig)
...
function XUiPanelGachaLiv4P5Record:SetLogData(name, templateId, from, time, quality)
...
return XUiPanelGachaLiv4P5Record