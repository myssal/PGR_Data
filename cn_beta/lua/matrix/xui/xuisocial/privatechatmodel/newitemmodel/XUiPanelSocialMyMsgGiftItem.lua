...
function XUiPanelSocialMyMsgGiftItem:AutoInitUi()
    ...
    -- self.RImgHead = self.Transform:Find("PanelRole/RImgHead"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    ...
    -- self.RImgIcon = self.Transform:Find("PanelMsg/Content/RImgIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    -- self.BtnClick = self.Transform:Find("PanelMsg/Content/BtnClick"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    -- self.ImgGet = self.Transform:Find("PanelMsg/Content/ImgGet"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.ImgNoGet = self.Transform:Find("PanelMsg/Content/ImgNoGet"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.ImgFetch = self.Transform:Find("PanelMsg/Content/ImgFetch"):GetComponent(typeof(CS.UnityEngine.UI.Image))
end
