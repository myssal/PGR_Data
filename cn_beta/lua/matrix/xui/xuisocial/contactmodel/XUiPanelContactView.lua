...
function XUiPanelContactView:AutoInitUi()
    ...
    -- self.BtnRemove = self.Transform:Find("PanelDeleteFriend/BtnRemove"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    -- self.TxtFriendCount = self.Transform:Find("Share/TxtFriendCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
