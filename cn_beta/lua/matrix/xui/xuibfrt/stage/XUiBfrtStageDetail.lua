...
function XUiBfrtStageDetail:AutoInitUi()
    ...
    self.TxtDrop = self.Transform:Find("SafeAreaContentPane/Panellist/PanelDropList/PanelDrop/TxtDrop"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtDropEn = self.Transform:Find("SafeAreaContentPane/Panellist/PanelDropList/PanelDrop/TxtDropEn"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtFirstDrop = self.Transform:Find("SafeAreaContentPane/Panellist/PanelDropList/PanelDrop/TxtFirstDrop"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtAllNums = self.Transform:Find("SafeAreaContentPane/Panellist/PanelNums/TxtAllNums"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtLeftNums = self.Transform:Find("SafeAreaContentPane/Panellist/PanelNums/TxtLeftNums"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnAddNum = self.Transform:Find("SafeAreaContentPane/Panellist/PanelNums/BtnAddNum"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelBottom = self.Transform:Find("SafeAreaContentPane/Panellist/PanelBottom")
    self.TxtATNums = self.Transform:Find("SafeAreaContentPane/Panellist/PanelBottom/TxtATNums"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnEnter = self.Transform:Find("SafeAreaContentPane/Panellist/PanelBottom/BtnEnter"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelDesc = self.Transform:Find("SafeAreaContentPane/Panellist/PanelDesc")
    self.TxtTitle = self.Transform:Find("SafeAreaContentPane/Panellist/PanelDesc/TxtTitle"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtLevelVal = self.Transform:Find("SafeAreaContentPane/Panellist/PanelDesc/TxtLevelVal"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.RImgNandu = self.Transform:Find("SafeAreaContentPane/Panellist/PanelDesc/RImgNandu"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    self.TxtDesc = self.Transform:Find("SafeAreaContentPane/Panellist/PanelDesc/TxtDesc"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    ...
    self.TxtStarActive1 = self.Transform:Find("SafeAreaContentPane/Panellist/PanelTargetList/GridStar1/TxtStarActive1"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.GridStar2 = self.Transform:Find("SafeAreaContentPane/Panellist/PanelTargetList/GridStar2")
    self.TxtStarActive2 = self.Transform:Find("SafeAreaContentPane/Panellist/PanelTargetList/GridStar2/TxtStarActive2"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.GridStar3 = self.Transform:Find("SafeAreaContentPane/Panellist/PanelTargetList/GridStar3")
    self.TxtStarActive3 = self.Transform:Find("SafeAreaContentPane/Panellist/PanelTargetList/GridStar3/TxtStarActive3"):GetComponent(typeof(CS.UnityEngine.UI.Text))
