...
function XUiHostelCharacterWork:AutoInitUi()
    ...
    self.TxtSlotName = self.Transform:Find("SafeAreaContentPane/PanelSelectWork/PanelSlotInfo/TxtSlotName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtProductName = self.Transform:Find("SafeAreaContentPane/PanelSelectWork/PanelSlotInfo/TxtProductName"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtProductValue = self.Transform:Find("SafeAreaContentPane/PanelSelectWork/PanelSlotInfo/TxtProductValue"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelRight = self.Transform:Find("SafeAreaContentPane/PanelSelectWork/PanelRight")
    self.SViewIdleCharList = self.Transform:Find("SafeAreaContentPane/PanelSelectWork/PanelRight/SViewIdleCharList"):GetComponent(typeof(CS.UnityEngine.UI.ScrollRect))
    ...
    self.TxtCostVitality = self.Transform:Find("SafeAreaContentPane/PanelSelectWork/PanelRight/TxtCostVitality"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCostTime = self.Transform:Find("SafeAreaContentPane/PanelSelectWork/PanelRight/TxtCostTime"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.BtnCharWork = self.Transform:Find("SafeAreaContentPane/PanelSelectWork/PanelRight/BtnCharWork"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
