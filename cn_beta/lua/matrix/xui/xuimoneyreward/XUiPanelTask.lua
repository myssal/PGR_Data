...
function XUiPanelTask:AutoInitUi()
    ...
    -- self.ImgDone = self.Transform:Find("PanelDone/ImgDone"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.PanelTask = self.Transform:Find("PanelTask")
    -- self.PanelHead = self.Transform:Find("PanelTask/PanelHead")
    -- self.RImgPic = self.Transform:Find("PanelTask/PanelHead/RImgPic"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    -- self.ImgQuality = self.Transform:Find("PanelTask/PanelHead/ImgQuality"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.BtnClick = self.Transform:Find("PanelTask/PanelHead/BtnClick"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    -- self.BtnGo = self.Transform:Find("PanelTask/BtnGo"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    -- self.BtnGet = self.Transform:Find("PanelTask/BtnGet"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    -- self.TxtLevel = self.Transform:Find("PanelTask/TxtLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.PanelNone = self.Transform:Find("PanelNone")
    -- self.BtnSelectedTask = self.Transform:Find("PanelNone/BtnSelectedTask"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
