...
function XUiPanelTaskCard:AutoInitUi()
    -- self.ImgLevel = self.Transform:Find("ImgLevel"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.ImgBG = self.Transform:Find("ImgLevel/ImgBG"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.TxtLevel = self.Transform:Find("ImgLevel/ImgBG/TxtLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.RImgRoleIcon = self.Transform:Find("ImgLevel/RImgRoleIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    -- self.ImgIconQuality = self.Transform:Find("ImgLevel/ImgIconQuality"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    ...
    -- self.TxtBuff = self.Transform:Find("Image/TxtBuff"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.PanelReward = self.Transform:Find("PanelReward")
    -- self.GridCommon = self.Transform:Find("PanelReward/GridCommon")
    -- self.RImgIcon = self.Transform:Find("PanelReward/GridCommon/RImgIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    -- self.PanelSite = self.Transform:Find("PanelReward/GridCommon/PanelSite")
    -- self.TxtSite = self.Transform:Find("PanelReward/GridCommon/PanelSite/TxtSite"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.BtnAccept = self.Transform:Find("BtnAccept"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
