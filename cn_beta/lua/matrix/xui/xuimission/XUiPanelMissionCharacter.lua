...
function XUiPanelMissionCharacter:AutoInitUi()
    ...
    -- self.ImgBg = self.Transform:Find("PanelCha/ImgBg"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.PanelMask = self.Transform:Find("PanelCha/PanelMask")
    -- self.RImgCharacter = self.Transform:Find("PanelCha/PanelMask/RImgCharacter"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    -- self.ImgType = self.Transform:Find("PanelCha/Image/ImgType"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.TxtLevel = self.Transform:Find("PanelCha/Image/TxtLevel"):GetComponent(typeof(CS.UnityEngine.UI.Text))
