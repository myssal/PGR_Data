...
function XUiMission:Init()
    ...
    self.Timer = nil
    self.PanelPointRect = self.PanelPreview:GetComponent(typeof(CS.UnityEngine.RectTransform))
...
function XUiMission:AutoInitUi()
    ...
    -- self.BtnBack = self.Transform:Find("SafeAreaContentPane/PanelTopBtn/BtnBack"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    -- self.BtnMainUi = self.Transform:Find("SafeAreaContentPane/PanelTopBtn/BtnMainUi"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    -- self.TxtTimeRefresh = self.Transform:Find("SafeAreaContentPane/PanelTop/PanelTimeRefresh/TxtTimeRefresh"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.PanelResetCount = self.Transform:Find("SafeAreaContentPane/PanelTop/PanelResetCount")
    -- self.TxtResetCount = self.Transform:Find("SafeAreaContentPane/PanelTop/PanelResetCount/TxtResetCount"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.PanelSending = self.Transform:Find("SafeAreaContentPane/PanelTop/PanelSending")
    -- self.ImgRedTag = self.Transform:Find("SafeAreaContentPane/PanelTop/PanelSending/ImgRedTag"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    -- self.TxtSending = self.Transform:Find("SafeAreaContentPane/PanelTop/PanelSending/TxtSending"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.BtnTips = self.Transform:Find("SafeAreaContentPane/PanelTop/PanelSending/BtnTips"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    -- self.BtnRefresh = self.Transform:Find("SafeAreaContentPane/PanelTop/BtnRefresh"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    -- self.PanelRefresh = self.Transform:Find("SafeAreaContentPane/PanelTop/BtnRefresh/PanelRefresh")
    -- self.RImgCostIcon = self.Transform:Find("SafeAreaContentPane/PanelTop/BtnRefresh/PanelRefresh/RImgCostIcon"):GetComponent(typeof(CS.UnityEngine.UI.RawImage))
    -- self.TxtCost = self.Transform:Find("SafeAreaContentPane/PanelTop/BtnRefresh/PanelRefresh/TxtCost"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    -- self.BtnRefreshFree = self.Transform:Find("SafeAreaContentPane/PanelTop/BtnRefreshFree"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    -- self.BtnPreview = self.Transform:Find("SafeAreaContentPane/PanelDown/BtnPreview"):GetComponent(typeof(CS.UnityEngine.UI.Button))
end
