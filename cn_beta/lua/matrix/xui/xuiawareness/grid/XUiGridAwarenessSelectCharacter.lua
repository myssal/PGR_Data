...
function XUiGridAwarenessSelectCharacter:Refresh(character, chapterData)
    ...
    self.PanelCurrOccupy:Find("Text"):GetComponent(typeof(CS.UnityEngine.UI.Text)).text = CS.XTextManager.GetText("AwarenessOccupyThisMember")
    self.PanelOtherOccupy:Find("Text"):GetComponent(typeof(CS.UnityEngine.UI.Text)).text = CS.XTextManager.GetText("AwarenessOccupyOtherMember")
    -- 独域图标
