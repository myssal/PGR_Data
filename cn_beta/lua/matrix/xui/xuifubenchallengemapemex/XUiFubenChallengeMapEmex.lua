...
function XUiFubenChallengeMapEmex:AutoInitUi()
    self.BtnActDesc = self.Transform:Find("SafeAreaContentPane/LayerWrap/BtnActDesc"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtPipei = self.Transform:Find("SafeAreaContentPane/LayerWrap/BtnActDesc/TxtPipei"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelEvent = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelEvent")
    self.TxtEventDesc = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelEvent/head/TxtEventDesc"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelTip = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTip")
    self.BtnCancelMatch = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTip/BtnCancelMatch"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.TxtPipeiA = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTip/TxtPipei"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.PanelBottom = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelBottom")
    self.TxtProgress = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelBottom/GameObject/TxtProgress"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.ImgSlide = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelBottom/GameObject/ImgSlide"):GetComponent(typeof(CS.UnityEngine.UI.Image))
    self.BtnReward = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelBottom/GameObject/BtnReward"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    ...
    self.BtnBack = self.Transform:Find("SafeAreaContentPane/LayerWrap/Top/BtnBack"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.BtnMainUi = self.Transform:Find("SafeAreaContentPane/LayerWrap/Top/BtnMainUi"):GetComponent(typeof(CS.UnityEngine.UI.Button))
    self.PanelTitle = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTitle")
    self.TxtShuaxin = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTitle/TxtShuaxin"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtCurTime = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTitle/TxtCurTime"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtBt = self.Transform:Find("SafeAreaContentPane/LayerWrap/PanelTitle/TxtBt"):GetComponent(typeof(CS.UnityEngine.UI.Text))
