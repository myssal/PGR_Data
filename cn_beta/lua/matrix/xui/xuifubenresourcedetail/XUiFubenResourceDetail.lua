...
function XUiFubenResourceDetail:AutoInitUi()
    ...
    self.TxtActive3 = self.Transform:Find("SafeAreaContentPane/PanelTargetList/TxtActive3"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtActive2 = self.Transform:Find("SafeAreaContentPane/PanelTargetList/TxtActive2"):GetComponent(typeof(CS.UnityEngine.UI.Text))
    self.TxtActive1 = self.Transform:Find("SafeAreaContentPane/PanelTargetList/TxtActive1"):GetComponent(typeof(CS.UnityEngine.UI.Text))
